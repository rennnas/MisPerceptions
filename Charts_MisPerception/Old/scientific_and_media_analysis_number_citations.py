...
bplot = ax[0].boxplot(df_allcov['Sci_cit_dis'], vert=False, notch=False, patch_artist=True, widths=0.7,
                      showmeans=False, showfliers=False, medianprops={'color': 'red'}, meanprops={'marker': 'x'})
...
ax[0].set_yticks(np.arange(1, len(df_topiclist['Topic_sci'].tolist())+1))
...
ax[0].set_xlabel('Number of citations per year', fontsize=6)
