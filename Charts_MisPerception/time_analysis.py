...
for country_name in countries:
    ...
    ax1.legend(handles=handles, loc='upper center', bbox_to_anchor=(0.5, -0.25),
               fancybox=True, ncol=5)

    # ax1.get_legend().set_title(country_name)

    ax0.legend(handles=handles_evs, loc='upper center', bbox_to_anchor=(0.5, 2.9),
